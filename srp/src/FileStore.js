...
var FileStore = /** @class */ (function () {
    function FileStore(_directory, _logger) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fs_1.promises.writeFile(fileFullName, message)
                                .then(function () { return _this.logger.saved(id); })["catch"](function (err) { return _this.logger.errorSaving(id); })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
