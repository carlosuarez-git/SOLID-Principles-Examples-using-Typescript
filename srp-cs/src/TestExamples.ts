...
var message2 = cache.getItemContent(2);
console.log();
...
(async () => {
  ...
  console.log()
  var filestore = new FileStore(dirtest, logger, cache)
  var file = new File(dirtest);
  var fileInfo = file.getFileInfo(1)
  ...
  console.log()
  var fileStore = new FileStore(dirtest, logger, cache);
  await fileStore.save(99, 'Message 99 saved via MessageStore class')
  var fileMessage99 = fileStore.read(99)
